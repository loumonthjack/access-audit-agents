...
export function ReportView({ report }: ReportViewProps) {
    ...
    const tabs: Tab[] = [
        { id: 'violations', label: 'All Violations', shortLabel: 'Violations', count: report.violations?.length ?? 0 },
        ...
        { id: 'human-review', label: 'Human Review', shortLabel: 'Review', count: report.humanReview?.length ?? 0 },
        ...(report.pageScreenshot ? [{ id: 'page-screenshot' as TabId, label: 'Page Screenshot', shortLabel: 'Screenshot', count: 1 }] : []),
    ];
            ...
            <Card padding="none">
                ...
                <CardContent className="p-3 sm:p-4">
                    {activeTab === 'violations' && (
                        <div className="space-y-3 sm:space-y-4" role="tabpanel" id="tabpanel-violations" aria-labelledby="tab-violations">
                    ...
                    {activeTab === 'fixes' && (
                        <div className="space-y-3 sm:space-y-4" role="tabpanel" id="tabpanel-fixes" aria-labelledby="tab-fixes">
                            {(report.fixes?.length ?? 0) === 0 ? (
                                ...
                                report.fixes?.map((fix) => (
                                    <FixCard key={fix.violationId} fix={fix} />
                                ))
                            )}
                        </div>
                    )}
                    ...
                    {activeTab === 'human-review' && (
                        <div className="space-y-3 sm:space-y-4" role="tabpanel" id="tabpanel-human-review" aria-labelledby="tab-human-review">
                                        ...
                                        <CardContent className="p-3 sm:p-4 pt-0">
                                            <dl className="space-y-2 text-xs sm:text-sm">
                                                <div>
                                                    ...
                                                    <dd className="font-mono text-neutral-600 break-all">
                                                        {item.selector}
                                                    </dd>
                                                </div>
                                                <div>
                    ...
                    {activeTab === 'page-screenshot' && report.pageScreenshot && (
                        <div className="space-y-3 sm:space-y-4" role="tabpanel" id="tabpanel-page-screenshot" aria-labelledby="tab-page-screenshot">
