 ...
 */
const impactLevelArbitrary = fc.constantFrom('critical' as const, 'serious' as const, 'moderate' as const, 'minor' as const);
 ...
 */
const appliedFixArbitrary = (violationId: string) => fc.record({
