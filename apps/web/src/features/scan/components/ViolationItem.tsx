    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Description */}
          <p className="text-sm text-neutral-900 line-clamp-2">{violation.description}</p>

          {/* Selector */}
          <p className="text-xs text-neutral-500 mt-1 font-mono truncate">{violation.selector}</p>
        </div>
        ...
        >
          <div className="pt-3 space-y-3">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-700">{violation.help}</p>
            </div>
            ...
            {violation.status === 'skipped' && violation.skipReason && (
              <div>
                ...
                <p className="text-sm text-error-600">{violation.skipReason}</p>
              </div>
            )}
