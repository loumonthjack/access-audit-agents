...
function SummaryStats({ report }: { report: BatchReportType }) {
  ...
  const successRate =
    summary.totalPages > 0 ? Math.round((summary.successfulPages / summary.totalPages) * 100) : 0;
 ...
 */
function ViolationsByImpactChart({
  violationsByImpact,
}: {
    ...
    <Card className="space-y-4" data-testid="violations-by-impact">
      ...
      {total === 0 ? (
        ...
        <>
          ...
          <div
            className="h-8 flex rounded-lg overflow-hidden"
            role="img"
            aria-label="Violations by impact level"
          >
        ...
        {topViolations.map((violation, index) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-neutral-700 line-clamp-2">{violation.description}</p>
            </div>
    ...
    <div className="border border-neutral-200 rounded-lg overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3 min-w-0 flex-1">
          ...
          <span className="text-sm font-mono text-neutral-700 truncate">{page.url}</span>
        </div>
    ...
    <div className="space-y-6" data-testid="batch-report">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
          ...
          {report.sitemapUrl && (
            <p className="text-sm text-neutral-500 mt-1 font-mono">{report.sitemapUrl}</p>
          )}
