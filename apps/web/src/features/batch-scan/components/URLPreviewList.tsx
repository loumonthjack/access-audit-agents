  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-medium text-neutral-100">URLs Discovered</h3>
      ...
      <div className="border border-neutral-700 rounded-lg overflow-hidden">
        ...
        <div className="bg-neutral-800 px-4 py-3 border-b border-neutral-700">
          <div className="flex items-center gap-4">
            ...
            <div className="w-28 text-sm font-medium text-neutral-300 text-center">
              Last Modified
            </div>
      ...
      <div className="flex items-center justify-end gap-3 pt-4 border-t border-neutral-700">
        ...
        >
          {isLoading ? 'Starting Batch Scan...' : <>Start Batch Scan ({selectedUrls.size} URLs)</>}
        </Button>
      </div>
    </div>
  );
