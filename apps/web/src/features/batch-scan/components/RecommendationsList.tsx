...
import type { BatchRecommendation } from '@/types/domain';
...
function RecommendationItem({
  ...
  return (
    ...
    >
      ...
      {/* Description */}
      <p className="text-sm text-neutral-700 mb-3">{recommendation.description}</p>
      ...
      <div className="flex items-start gap-2 p-3 bg-white rounded-lg border border-neutral-200">
        ...
        <div>
          ...
          <p className="text-sm text-neutral-700">{recommendation.suggestedAction}</p>
        </div>
      </div>
    </div>
  );
...
function EmptyState() {
  return (
    <div className="text-center py-8">
      ...
      <h4 className="text-lg font-medium text-neutral-900 mb-1">No recommendations</h4>
...
export function RecommendationsList({ recommendations, className }: RecommendationsListProps) {
  ...
  const mediumPriority = sortedRecommendations.filter(
