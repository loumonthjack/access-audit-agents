 ...
 */
import type { ScanSession, Violation, AppliedFix, RemediationReport, BatchProgress, BatchSummary } from './domain';
 ...
 */
export type ExtractBatchEvent<T extends BatchProgressEventType> = Extract<BatchProgressEvent, { type: T }>;
