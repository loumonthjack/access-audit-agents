      ...
      <div className="rounded-2xl border border-dashed border-neutral-700/50 bg-neutral-900/20 p-8 sm:p-12 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="space-y-1">
            <p className="text-base font-medium text-neutral-300">No scans yet</p>
            <p className="text-sm text-neutral-500">Start your first accessibility scan above!</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-4">
      {sessions.map((session) => (
        <SessionCard key={session.id} session={session} onView={handleView} />
      ))}
    </div>
  );
}
...
function RecentBatchScans() {
    ...
    return (
      <div className="rounded-2xl border border-dashed border-neutral-700/50 bg-neutral-900/20 p-8 sm:p-12 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="space-y-1">
            <p className="text-base font-medium text-neutral-300">No batch scans yet</p>
  ...
  return (
    <div className="space-y-4">
      {sessions.map((session) => (
        <BatchSessionCard key={session.id} session={session} onView={handleView} />
      ))}
    </div>
  );
}
    ...
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="text-center space-y-6 max-w-md mx-auto px-4">
        ...
        <div className="relative mx-auto w-20 h-20">
          ...
          <div
            className="absolute -inset-2 rounded-3xl border-2 border-primary-500/30 animate-ping"
        ...
        <div className="space-y-2">
          ...
          <p className="text-neutral-400">Analyzing accessibility for</p>
          <p className="text-primary-400 font-medium truncate">{url}</p>
        </div>
            ...
            <div className="relative flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-400">
                  Enter a URL to analyze for accessibility issues
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="relative mx-auto max-w-2xl">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <svg
              className="h-5 w-5 text-neutral-500 group-hover:text-cyan-400 group-hover:translate-x-1 transition-all"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
