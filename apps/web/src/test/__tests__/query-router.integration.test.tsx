...
import { scanApi, getSession, startScan } from '@/features/scan/api/scanApi';
import { reportApi, getReport } from '@/features/report/api/reportApi';
import { historyApi, listSessions } from '@/features/history/api/historyApi';
import { createTestQueryClient, createHookWrapper } from '../utils';
import { createMockSession, createMockReport, resetMockData } from '../mocks/handlers';
import type { ScanSession, RemediationReport } from '@/types/domain';
...
describe('Query + Router Integration Tests', () => {
    ...
    describe('Navigation with Params', () => {
        ...
        it('should handle different session IDs correctly', async () => {
            ...
            const cached1 = queryClient.getQueryData(queryKeys.sessions.detail(sessionId1)) as ScanSession;
            const cached2 = queryClient.getQueryData(queryKeys.sessions.detail(sessionId2)) as ScanSession;
